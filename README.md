...
- [📖 Budget app ](#-capstone_project_2_api-)
...
- Takes a record of all the expenses of the user
- Organize the expenses in categories
...
> git clone https://github.com/DavidEspinoG/microverse_rails_capstone.git
